...
app.get('/', function(req, res) {
  res.status(200).send("<p><a href=\"mailto:support@allmyppl.com?subject=I%27m%20have%20some%20questions,%20comments,%20concerns%20or%20feedback%20about%20AllMyPPL&body=I%20have%20a%20question%20or%20am%20confused%20about...%0A%0AI%20take%20issue%20with...%0A%0AHave%20you%20thought%20about...%0A%0AI%20really%20like....%0A%0A\">Contact AllMyPPL Support By Email</a></p><p style=\"\">For contact retrieval and management through text messaging, send a friendly greeting to our automated attendant at the number below.</p><p><a id=\"allMyPPLPhoneNumber\">+1 (650) 206-2610</a></p></div></div><script type=\"text/javascript\">if (navigator.userAgent.match(/iPhone|iPad|iPod/i)) {document.getElementById(\"allMyPPLPhoneNumber\").href = \"sms:+16502062610\";} else {document.getElementById(\"allMyPPLPhoneNumber\").href=\"\"}</script></body></html>");
});
