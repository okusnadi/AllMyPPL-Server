...
Parse.Cloud.beforeSave(Parse.User, (req, res) => {
  ...
  else if (obj.get('username').length != 10) {res.error(new Parse.Error(Parse.Error.VALIDATION_ERROR,"Usernames must consist of only numbers and be 10 digits in length."));}
  else {res.success();}
});
