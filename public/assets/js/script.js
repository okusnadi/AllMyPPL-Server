...
ParseRequest.postData = function() {
  ...
  XHR.POST('/parse/classes/Contact');
}
...
XHR.POST = function(path, callback) {
  var seed = {"name":"Patrick Blaine","email":"apatrickstar@icloud.com","phone":"6505878510"}
  this.xhttp.open("POST", Config.getUrl() + path, true);
  this.xhttp.setRequestHeader("X-Parse-Application-Id", "AllMyPeople");
